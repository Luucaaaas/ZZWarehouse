...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 23 mars 2024 à 18:40
...
(55, 4, 1, 10, 'Sortie', '2024-03-23 18:12:45', 'En attente'),
(56, 4, 30, 90, 'Sortie', '2024-03-23 18:39:39', 'En attente'),
(57, 4, 7, 17, 'Sortie', '2024-03-23 18:39:48', 'En attente');
...
(6, 'Nicolas', 'Barbet', 'n.barbet@le-fourniseur.com', '$2y$10$b/cXPWwVCik/otWCHEzw6OUDGwNEqNXmtrVH8DvFl9rgUcXn8eIGu', 4, 0, NULL),
(7, 'Smith', 'Emily', 'emilysmith@gmail.fr', '$2y$10$N4u.LUvm91Wfv4A51WDkIeu4gM4ayanyALFym.q5VUzz2.ZDDLpdK', 2, 0, NULL),
(76, 'Johnson', 'Michael', 'michaeljohnson@yahoo.com', '$2y$10$N4u.LUvm91Wfv4A51WDkIeu4gM4ayanyALFym.q5VUzz2.ZDDLpdK', 4, 0, NULL),
...
--
ALTER TABLE `stocks`
  MODIFY `id_stock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;

--
-- AUTO_INCREMENT pour la table `utilisateurs`
--
ALTER TABLE `utilisateurs`
  MODIFY `id_utilisateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
